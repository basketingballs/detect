                      ...
                      <div className="flex h-full flex-col overflow-y-scroll bg-slate-50 py-6 shadow-xl">
                        <div className="px-4 sm:px-6">
                          <Dialog.Title className="text-base font-semibold leading-6 text-gray-900">
                            <div div className="fixed top-0 left-0 bottom-0 w-full z-10 overflow-y-scroll">
                              <ul className="flex pt-6 justify-evenly text-slate-800 text-md text-sans">

                                <li onClick={() => handleComponentClick('profile')} className={`cursor-pointer hover:text-indigo-600 ${activeComponent === 'profile' ? 'text-indigo-700 shadow-lg underline underline-offset-8 underline decoration-2' : 'bg-slate-50'}`}>
                                  Profile
                                </li>

                                <li onClick={() => handleComponentClick('notification')} className={`cursor-pointer hover:text-indigo-600 ${activeComponent === 'notification' ? 'text-indigo-700 shadow-lg underline underline-offset-8 underline decoration-2' : 'bg-slate-50'}`}>
                                  Notification
                                </li>
