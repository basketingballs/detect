  ...
  const getSpecs = async () => {
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/doctor/speciality`,
        options
      );
                  ...
                  <form>
                    <div className="grid grid-cols-2 mb-6 mx-4 gap-12 py-8 ">
                      ...
                      <div className="relative h-11 w-full min-w-[200px]">
                        ...
                        >
                          <div>
                            <Menu.Button className="inline-flex w-full justify-right text-sm font-sans text-gray-900 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                              Speciality
                            </Menu.Button>
                          </div>
                          <Transition
