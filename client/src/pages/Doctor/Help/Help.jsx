        ...
        <div className='w-full px-4 py-5 bg-white rounded-md shadow-xl'>
            <form className='my-6 flex justify-center'>
                ...
                <div
                    ...
                    className="ml-2 px-12 py-2 rounded-lg bg-teal-600 text-white hover:bg-white hover:text-teal-800 hover:border-solid border-2 border-teal-600 duration-700"
                >
                    Send
                </div>
            </form>
