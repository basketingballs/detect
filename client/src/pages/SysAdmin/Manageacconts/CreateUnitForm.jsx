...
const CreateUnitForm = ({ open, setOpen }) => {
    ...
    const signup = async (e) => {
        ...
        if (formValidation()) {
            ...
            try {
                const response = await PersonService.createUnit(data);
                        ...
                        >
                            <Dialog.Panel className='transform overflow-y-scroll rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                                ...
                                <div className='w-full px-5 py-3 bg-white'>
                                    <h1 className='text-4xl font-semibold text-center text-blue-700 pb-4'>Add Unit</h1>
                                    <form>
